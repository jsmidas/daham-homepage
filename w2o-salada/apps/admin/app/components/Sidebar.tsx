...
const menuItems = [
  ...
  { href: "/orders", icon: "receipt_long", label: "주문 관리" },
  { href: "/products", icon: "inventory_2", label: "상품 관리" },
  { href: "/subscriptions", icon: "autorenew", label: "구독 관리" },
  { href: "/delivery", icon: "local_shipping", label: "배송 관리" },
  { href: "/members", icon: "people", label: "회원 관리" },
  { href: "/stats", icon: "bar_chart", label: "통계" },
    ...
    <aside className="w-60 bg-[#1a1f2e] min-h-screen flex flex-col">
      ...
      <div className="h-16 flex items-center px-5 border-b border-white/5">
        <Link href="/dashboard" className="flex items-center gap-2">
          ...
          <span className="text-xs text-white/50 tracking-widest">ADMIN</span>
        </Link>
      </div>
