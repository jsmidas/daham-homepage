...
export default function PricingClient({
  ...
  const [minOrderAmount, setMinOrderAmount] = useState(initialSettings.minOrderAmount ?? "11000");
  const [minDirty, setMinDirty] = useState(false);
  const [trialPrice, setTrialPrice] = useState(initialSettings["subscribe.trial.price"] ?? "6900");
